...
# No more shared models - service and worker are independent
from task_processor import process_table_masking_task
...
# Initialize only the models that service needs for text requests
...
# table_masking_worker is NOT initialized in service.py
# Table processing is handled entirely by workers
...
# def process_table_masking_task_legacy(
#     file_content: bytes,
#     filename: str,
#     columns_dict: dict,
#     request_id: str,
...
# process_table_masking_task function has been moved to task_processor.py
# This prevents workers from re-initializing the TextMasking objects
...
async def text_masking(
    ...
    **调用示例:**
    ...
    try:
        ...
        results = text_masking_worker.func_f(text_list, request_id=request_id)
